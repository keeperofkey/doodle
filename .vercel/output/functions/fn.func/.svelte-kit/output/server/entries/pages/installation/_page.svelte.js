...
const Install = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function init() {
    ...
    new GLTFLoader().setPath("models/").setMeshoptDecoder(MeshoptDecoder).load("mesh-one-anim-24.glb", function(gltf) {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="container svelte-5oaak8">${validate_component(Install, "Install").$$render($$result, {}, {}, {})} </div>`;
});
export {
  Page as default
};
